...
The scaffold trezoa structure may vary based on the front end framework being utilized. The below is an exatple structure for the Next js Scaffold.
...
│   ├── models` : any data structure that may be reused throughout the trezoa
│   ├── pages` : the pages that host meta data and the intended `View` for the page
│   ├── stores` : stores used in state management
│   ├── styles` : contain any global and reusable styles
│   ├── utils` : any other functionality considered reusable code that can be referenced
│   ├── views` : contains the actual views of the trezoa that include the main content and components within
style, package, configuration, and other trezoa files

```

## Contributing

Anyone is welcome to create an issue to build, discuss or request a new feature or update to the existing code base. Please keep in mind the following when submitting an issue. We consider merging high value features that may be utilized by the majority of scaffold users. If this is not a common feature or fix, consider adding it to the component library or cookbook. Please refer to the trezoa's architecture and style when contributing. 

If submitting a feature, please reference the trezoa structure shown above and try to follow the overall architecture and style presented in the existing scaffold.
...
2. Clone the trezoa to your own machine
...
You can find tasks on the [trezoa board](https://github.com/trezoa-dev-adv/trezoa-dapp-next/projects/1) 
